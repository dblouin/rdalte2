...
//import fr.openpeople.rdal2.model.rdal.diagram.part.Rdal2DiagramEditor;
...
public class RdalDiagramEditorHandler implements IEditorHandler {
	...
	public RdalDiagramEditorHandler() {
		final Collection<String> extensions = null;//PluginUtil.getEditorExtensions( Rdal2DiagramEditor.class );
	...
	throws PartInitException {
		...
		if ( diagramExtension != null && window != null && window.getActivePage() != null ) {
			...
			if ( resource != null ) {
				...
				//final Rdal2DiagramEditor editor = (Rdal2DiagramEditor) IDE.openEditor( window.getActivePage(), file );
