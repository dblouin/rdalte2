...
public interface IContractualElementTraceabilityBusinessDelegate {
	...
	boolean isDesignElementSatisfiable( Object p_context,
										EObject p_designElement )
	throws ConstraintException, SystemException;

	boolean isDesignElementSatisfiableInclContainers( 	Object p_context,
														EObject p_designElement )
	throws ConstraintException, SystemException;
	 ...
	 * @return
	 */
	Collection<EClass> supportedDesignSpecificationTypes( Object p_context )
	throws ConstraintException, SystemException;
