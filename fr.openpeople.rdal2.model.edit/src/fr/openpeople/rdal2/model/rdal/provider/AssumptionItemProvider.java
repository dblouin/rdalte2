...
/**
 * This is the item provider adapter for a {@link fr.openpeople.rdal2.model.rdal.Assumption} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RdalPackage.Literals.ASSUMPTION__IMAGE_REQUIREMENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addImageAssumptionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assumption_imageAssumptions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assumption_imageAssumptions_feature", "_UI_Assumption_type"),
				 RdalPackage.Literals.ASSUMPTION__IMAGE_ASSUMPTIONS,
				 true,
				 false,
				 true,
				 null,
