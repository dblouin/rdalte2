...
/**
 * This is the item provider adapter for a {@link fr.openpeople.rdal2.model.rdal.SatisfiableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SatisfiableElementItemProvider
	 ...
	 * @generated
	 */
	public SatisfiableElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		Float labelValue = ((SatisfiableElement)object).getSatisfactionLevel();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SatisfiableElement_type") :
			getString("_UI_SatisfiableElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SatisfiableElement.class)) {
