...
/**
 * This is the item provider adapter for a {@link fr.openpeople.rdal2.model.rdal.AbstractGoal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractGoalItemProvider
	 ...
	 * @generated
	 */
	public AbstractGoalItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addConflictsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractGoal_conflicts_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractGoal_conflicts_feature", "_UI_AbstractGoal_type"),
				 RdalPackage.Literals.ABSTRACT_GOAL__CONFLICTS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((AbstractGoal)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractGoal_type") :
			getString("_UI_AbstractGoal_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractGoal.class)) {
