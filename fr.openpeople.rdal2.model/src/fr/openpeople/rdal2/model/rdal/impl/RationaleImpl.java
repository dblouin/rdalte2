 ...
 * </p>
 * <ul>
 *   <li>{@link fr.openpeople.rdal2.model.rdal.impl.RationaleImpl#getStakeholders <em>Stakeholders</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RationaleImpl extends IdentifiedElementImpl implements Rationale {
	...
	protected EClass eStaticClass() {
		return RdalPackage.Literals.RATIONALE;
	}
	...
	public EList<Stakeholder> getStakeholders() {
		if (stakeholders == null) {
			stakeholders = new EObjectResolvingEList<Stakeholder>(Stakeholder.class, this, RdalPackage.RATIONALE__STAKEHOLDERS);
		}
		return stakeholders;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RdalPackage.RATIONALE__STAKEHOLDERS:
